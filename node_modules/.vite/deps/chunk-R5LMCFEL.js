...
function useMediaQuery(query, initialValue, { getInitialValueInEffect } = {
  ...
  const [matches, setMatches] = (0, import_react3.useState)(getInitialValueInEffect ? false : getInitialValue(query, initialValue));
...
function useNetwork() {
  ...
  (0, import_react45.useEffect)(() => {
    ...
    if (_navigator.connection) {
      setStatus(__spreadValues7({ online: true }, getConnection()));
...
//# sourceMappingURL=chunk-R5LMCFEL.js.map
