      ...
      <footer>
        <div class="footer">
          ...
          <div class="row">
            <ul>
              <li>
                <a href="/GJCEIWebsite/AboutUs">Mandate</a>
              </li>
              <li>
                <a href="/GJCEIWebsite/NewsEvents">News & Events</a>
              </li>
              <li>
                <a href="/GJCEIWebsite/Activities">Activities</a>
              </li>
              <li>
                <a href="/GJCEIWebsite/ContactUs">Contact Us</a>
              </li>
            </ul>
          </div>
