...
<Text style={{fontSize:"30px",color:"#10243f",fontWeight:"700",margin:"50px 0"}}>Industrial Linkage</Text>
  ...
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage2}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage3}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage4} ></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage5}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage6}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage7}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage8}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage9}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage10}></img></div>
  <div class="card"><img className="LinkageImg" style={{height:"200px"}} src={Linkage1}></img></div>
